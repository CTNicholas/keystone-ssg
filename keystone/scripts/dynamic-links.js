...
// const minVersion = `function _createForOfIteratorHelper(t,e){var n;if("undefined"==typeof Symbol||null==t[Symbol.iterator]){if(Array.isArray(t)||(n=_unsupportedIterableToArray(t))||e&&t&&"number"==typeof t.length){n&&(t=n);var o=0,r=function(){};return{s:r,n:function(){return o>=t.length?{done:!0}:{done:!1,value:t[o++]}},e:function(t){throw t},f:r}}throw new TypeError("Invalid attempt to iterate non-iterable instance. In order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var a,c=!0,l=!1;return{s:function(){n=t[Symbol.iterator]()},n:function(){var t=n.next();return c=t.done,t},e:function(t){l=!0,a=t},f:function(){try{c||null==n.return||n.return()}finally{if(l)throw a}}}}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);return"Object"===n&&t.constructor&&(n=t.constructor.name),"Map"===n||"Set"===n?Array.from(t):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(t,e):void 0}}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,o=new Array(e);n<e;n++)o[n]=t[n];return o}!function(){function t(t){var n,r,a,c;r=t.target,a=location.host===r.host,c=location.host+location.pathname+location.search!==r.host+r.pathname+r.search,a&&c&&((n=document.querySelector(".keystone-page-loading"))&&(n.style.display="block"),t.preventDefault(),o(t.target.getAttribute("href")).then(function(n){e(n,t.target.href)}))}function e(t,e){var n,o,r,a=arguments.length>2&&void 0!==arguments[2]&&arguments[2],c=(n=function(){var t=window.scrollY||document.documentElement.scrollTop||document.body.scrollTop||0;return{x:window.scrollX||document.documentElement.scrollLeft||document.body.scrollLeft||0,y:t}}(),o=n.x,r=n.y,{scroll:{x:o,y:r}});document.open(),document.write(t),document.close(),function(t,e,n){e||history.pushState(n,document.title,t)}(e,a,c)}function n(t){var n=location.href;o(n).then(function(o){var a,c;e(o,n,!0),a=t.state.scroll.x,c=t.state.scroll.y,r(function(){console.log("Scroll fix",a,c),window.scrollTo(a,c)})})}async function o(t){try{return fetch(t).then(function(t){return t.text()}).catch(function(){return console.log})}catch(e){console.log(e),window.location(t)}}function r(t){"interactive"===document.readyState||"complete"===document.readyState?t():document.addEventListener("DOMContentLoaded",function(){t()})}r(function(){!function(){var e,n=_createForOfIteratorHelper(document.querySelectorAll("a"));try{for(n.s();!(e=n.n()).done;){var o=e.value;o.addEventListener("click",t)}}catch(t){n.e(t)}finally{n.f()}}(),window.addEventListener("popstate",n)})}();`

const minVersion = `function _createForOfIteratorHelper(t,e){var n;if("undefined"==typeof Symbol||null==t[Symbol.iterator]){if(Array.isArray(t)||(n=_unsupportedIterableToArray(t))||e&&t&&"number"==typeof t.length){n&&(t=n);var o=0,r=function(){};return{s:r,n:function(){return o>=t.length?{done:!0}:{done:!1,value:t[o++]}},e:function(t){throw t},f:r}}throw new TypeError("Invalid attempt to iterate non-iterable instance. In order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var a,c=!0,l=!1;return{s:function(){n=t[Symbol.iterator]()},n:function(){var t=n.next();return c=t.done,t},e:function(t){l=!0,a=t},f:function(){try{c||null==n.return||n.return()}finally{if(l)throw a}}}}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);return"Object"===n&&t.constructor&&(n=t.constructor.name),"Map"===n||"Set"===n?Array.from(t):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(t,e):void 0}}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,o=new Array(e);n<e;n++)o[n]=t[n];return o}!function(){function t(t){if(r=t.target,a=location.host===r.host,c=location.host+location.pathname+location.search!==r.host+r.pathname+r.search,a&&c){var n=document.querySelector(".keystone-page-loading");!function(t){t&&(t.style.display="block")}(n),t.preventDefault(),o(t.target.getAttribute("href")).then(function(o){!function(t){t&&t.classList.add("keystone-page-loaded")}(n),e(o,t.target.href)})}var r,a,c}function e(t,e){var n,o,r,a=arguments.length>2&&void 0!==arguments[2]&&arguments[2],c=(n=function(){var t=window.scrollY||document.documentElement.scrollTop||document.body.scrollTop||0;return{x:window.scrollX||document.documentElement.scrollLeft||document.body.scrollLeft||0,y:t}}(),o=n.x,r=n.y,{scroll:{x:o,y:r}});document.open(),document.write(t),document.close(),function(t,e,n){e||history.pushState(n,document.title,t)}(e,a,c)}function n(t){var n=location.href;o(n).then(function(o){var a,c;e(o,n,!0),a=t.state.scroll.x,c=t.state.scroll.y,r(function(){console.log("Scroll fix",a,c),window.scrollTo(a,c)})})}async function o(t){try{return fetch(t).then(function(t){return t.text()}).catch(function(){return console.log})}catch(e){console.log(e),window.location(t)}}function r(t){"interactive"===document.readyState||"complete"===document.readyState?t():document.addEventListener("DOMContentLoaded",function(){t()})}r(function(){!function(){var e,n=_createForOfIteratorHelper(document.querySelectorAll("a"));try{for(n.s();!(e=n.n()).done;){var o=e.value;o.addEventListener("click",t)}}catch(t){n.e(t)}finally{n.f()}}(),window.addEventListener("popstate",n)})}();`
